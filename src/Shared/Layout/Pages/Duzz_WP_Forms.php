...
class Duzz_WP_Forms {
    ...
    public function duzz_render_staff_form() {
        $form_id_staff = Duzz_Get_Data::duzz_get_form_id('duzz_admin_settings_admin_form_id_field_data', 'form_id');
    ...
    public function duzz_render_customer_form() {
        $form_id_customer = Duzz_Get_Data::duzz_get_form_id('duzz_client_settings_client_form_id_field_data', 'form_id');
