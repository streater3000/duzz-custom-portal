...
class Duzz_Menu_Edit extends \Walker_Nav_Menu_Edit {
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $nonce_field = wp_nonce_field( 'menu_item_visibility_pass_request_nonce', 'menu-item-visibility-pass-request-nonce', true, false);
        
        // Add nonce field to the output with existing fields.
        $output .= $nonce_field . preg_replace('/(?=<div[^>]+class="[^"]*submitbox)/', $new_fields, $item_output);
    }
}
